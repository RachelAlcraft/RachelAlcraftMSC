...
html += tso.middleOverlayDefaults(calcX,calcY,set_nameA,res_choiceA,res_choiceAL, rv_choiceA,rv_choiceAL,rf_choiceA, rf_choiceAL,amino_codeA,set_nameB,res_choiceB,res_choiceBL,rv_choiceB,rv_choiceBL, rf_choiceB, rf_choiceBL, amino_codeB,restriction,gradient,html_dir)
html += tso.middleProbDiffRequest(calcX,calcY,set_nameA,restriction,res_choiceA,rv_choiceA,rf_choiceA, res_choiceAL,rv_choiceAL,rf_choiceAL, amino_codeA,set_nameB,res_choiceB,rv_choiceB,rf_choiceB, res_choiceBL,rv_choiceBL,rf_choiceBL, amino_codeB)
