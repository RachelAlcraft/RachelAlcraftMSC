...
html += hsc.middleReturnCorrelation(calcX,calcY,maxb,set_nameA,restriction,gradient,res_choiceA,rv_choiceA,rf_choiceA,res_choiceAL,rv_choiceAL,rf_choiceAL, amino_codeA,"scatter")
