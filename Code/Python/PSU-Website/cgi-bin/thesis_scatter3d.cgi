...
Date:      15/06/2020
Function:  A CGI file to vie 3d scatter plots
Description: 
============
...
html += hsc.middleReturnScatter3d(calcX,calcY,calcZ,maxb,set_nameA,restriction,gradient,res_choiceA,rv_choiceA,rf_choiceA,res_choiceAL,rv_choiceAL,rf_choiceAL, amino_codeA,"scatter")
