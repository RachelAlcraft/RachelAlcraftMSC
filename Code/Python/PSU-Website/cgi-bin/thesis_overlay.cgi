...
html += tso.middleOverlayRequest(calcX,calcY,maxb,set_nameA,restriction,res_choiceA,rv_choiceA,rf_choiceA, res_choiceAL,rv_choiceAL,rf_choiceAL, amino_codeA,set_nameB,res_choiceB,rv_choiceB,rf_choiceB, res_choiceBL,rv_choiceBL,rf_choiceBL, amino_codeB)
